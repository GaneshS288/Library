...
const swordPrincessAltina = new Book(
...
const hikaruGaChikyuu = new Book(
...
Book.addBookToLibrary(swordPrincessAltina);
Book.addBookToLibrary(braveStory);
Book.addBookToLibrary(mistborne);
Book.addBookToLibrary(hikaruGaChikyuu);
